...
model = dict(
    ...
    backbone=dict(
        ...
        arch='small',
        pretrained='https://download.openmmlab.com/mmaction/v1.0/recognition/swin/swin_small_patch4_window7_224.pth',  # noqa: E501
        pretrained2d=False,
        patch_size=(2, 4, 4),
        window_size=(8, 7, 7),
        mlp_ratio=4.,
...
data_root = '/Users/eddie/Trauma_THOMPSON/Trauma_THOMPSON/new_dataset/new_train/'
data_root_test = '/Users/eddie/Trauma_THOMPSON/Trauma_THOMPSON/new_dataset/new_test/'
